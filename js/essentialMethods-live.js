...
html = "<h4 class=\"best-seller-header\">Our Top Sellers</h4><ol><li class='hat-sold'>Fedora Hats</li><li class='hat-sold'>Baseball Hats</li><li class='hat-sold'>Cowboy Hats</li></ol>"
...
var warningRed = {"background-color": "cornflowerblue", "font-size": "72px"};
...
$("h1").css(warningRed).css("color", "rebeccapurple");
...
$(".hat-sold").last().html("<em>Fancy hats</em>"); //OOPS. Did  we just method chain? We sure did!

//.parent()
//TODO: Let's pop up the tree to the parent (<ol>) and use .css to change the list-style-type

$(".hat-sold").parent("ol").css("list-style-type", "upper-roman"); //Another method chain!
