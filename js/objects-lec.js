...
//console.log("Hey, Marco! I own a " + myCar["make"] + " " + myCar.model + "!") //Should concat from these two properties into this structure like we've been used to doing with variables
...
//myCar.features = ["Backup Camera/Side Mirror Camera", "Mesh Cloth", "Push Start", "6-Speed Transmission"]
...
myCar.turnOn = function () {
    alert("Pressing push to start and fired up my " + myCar.make + " " + myCar.model + " just fine!");
}
// myCar.turnOn = function () {
